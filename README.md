# Insurance Business Technology Curriculum

A comprehensive learning path for **IT Developers** and **Product Owners** working in the insurance industry.
...
- DevOps engineers and QA engineers

### Product Owners
- POs managing insurance product development
- Business analysts and technical product managers
...
Start Here
    ...
    ▼
┌─────────────────────────────────────────────────────────┐
│  FOUNDATION (Lessons 01-03)                             │
│  Insurance business, products, core processes           │
└─────────────────────────────────────────────────────────┘
    │
    ▼
┌─────────────────────────────────────────────────────────┐
│  TECHNICAL CORE (Lessons 04-06)                         │
│  Architecture, data models, API design                  │
└─────────────────────────────────────────────────────────┘
    │
    ▼
┌─────────────────────────────────────────────────────────┐
│  IMPLEMENTATION (Lessons 07-10)                         │
│  Security, development practices, testing, DevOps       │
└─────────────────────────────────────────────────────────┘
    │
    ▼
┌─────────────────────────────────────────────────────────┐
│  PRODUCT OWNERSHIP (Lesson 11)                          │
│  Domain knowledge for effective product management      │
└─────────────────────────────────────────────────────────┘
```
...
### Lesson 01 - Insurance Fundamentals
**Overview:** [README](./lesson-01-insurance-fundamentals/README.md)
...
### Lesson 02 - Insurance Products
**Overview:** [README](./lesson-02-insurance-products/README.md)
...
### Lesson 03 - Core Processes
**Overview:** [README](./lesson-03-core-processes/README.md)
...
**Overview:** [README](./lesson-04-system-architecture/README.md)
...
### Lesson 05 - Data Models
**Overview:** [README](./lesson-05-data-models/README.md)
...
### Lesson 06 - API Design
**Overview:** [README](./lesson-06-api-design/README.md)
...
**Overview:** [README](./lesson-07-security-compliance/README.md)
...
### Lesson 08 - Development Practices
**Overview:** [README](./lesson-08-development-practices/README.md)
...
**Overview:** [README](./lesson-09-testing-strategies/README.md)
...
**Overview:** [README](./lesson-10-devops-deployment/README.md)
...
**Overview:** [README](./lesson-11-product-owner-guide/README.md)
...
| **Subrogation** | Right to recover from third party after claim |

> See individual lessons for complete glossaries and detailed explanations.
...
### Industry Standards
- [ACORD Standards](https://www.acord.org) - Data standards for insurance
- [Insurance Information Institute](https://www.iii.org) - Industry research
